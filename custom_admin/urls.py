...
from .views import (
    admin_panel, edit_json, review_list, delete_review,
    user_list, delete_user, chat_list,
    subscription_list, add_subscription  # Импорт новых представлений
)
...
urlpatterns = [
    ...
    # Новые пути для управления подписками
