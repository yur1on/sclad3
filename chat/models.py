...
from django.db import models
from django.contrib.auth.models import User
from notifications.models import Notification  # Импортируем модель уведомлений
...
class Chat(models.Model):
    ...
    related_notification = models.ForeignKey(Notification, null=True, blank=True, on_delete=models.SET_NULL)
