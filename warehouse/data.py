...
DATA = {
    "Телефон": {
        ...
        "part_types": ["Аккумулятор", "Динамик музыкальный",  "Динамик слуховой",  "Дисплей", "Камера основная", "Камера фронтальная", "Сим-лоток", "Сканер отпечатка", "Стекло камеры", "Стекло для переклейки","Микросхема",
                       "Шлейф межплатный", "Шлейф сканера отпечатка", "Шлейф дисплея", "Шлейф боковых кнопок", ],
